...
<header data-bs-theme="dark">
	<nav class="navbar navbar-expand-md navbar-dark fixed-top " style="background:url('https://img.lovepik.com/png/20231003/the-korean-traditional-paper-cartoon-mountains-south-korea-retro_68896_wh860.png');background-size:contain;">
		<div class="container-fluid">
			<a class="navbar-brand" href="#"> Korea Cultural Property</a>
  ...
  ================================================== -->
		...
		<div class="container ">
			...
			<div class="row">
				<c:forEach var="item" items="${main}">
					<div class="col-lg-4">
						<img alt=""
							src="${item.ntimg}"
							class="box">
						<h2 class="fw-normal">${item.ntname}</h2>
						<p>${item.ntregion}</p>
						<p>
				...
				<div class="col-lg-4">
					<img alt=""
						src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/BellofKingSeongdeok.jpg/150px-BellofKingSeongdeok.jpg"
						class="box">
					<h2 class="fw-normal">성덕대왕신종</h2>
					<p>성덕대왕신종은 신라 시대에 제작된 대형 종으로, 경주 불국사에 소장되어 있습니다. 771년에 주조된 이 종은
						뛰어난 음향과 섬세한 조각이 특징이며, 신라의 금속 공예 기술을 보여주는 중요한 유물입니다.</p>
					<p>
						<a class="btn btn-secondary" href="#">View details »</a>
					</p>
				</div>
				...
				<div class="col-lg-4">
					<img alt=""
						src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Korea-Haeinsa-Tripitaka_Koreana-01.jpg/150px-Korea-Haeinsa-Tripitaka_Koreana-01.jpg"
						class="box">
					<h2 class="fw-normal">합천 해인사 대장경판</h2>
					<p>합천 해인사 대장경판은 고려시대에 제작된 세계 최대의 목판 불경입니다. 13세기 초기에 새겨진 이 경판은
						정확한 판각과 방대한 양으로 불교 경전의 중요성을 전하며, 유네스코 세계기록유산으로 등재된 한국의 귀중한
						문화유산입니다.</p>
					<p>
						<a class="btn btn-secondary" href="#">View details »</a>
					</p>
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="featurette-heading fw-normal lh-1">
						창덕궁 <span class="text-body-secondary">자연과 조화 이룬 조선 왕궁</span>
					</h2>
					<p class="lead">창덕궁은 조선 시대 왕궁으로, 아름다운 자연과 조화를 이룬 후원이 유명합니다.
						유네스코 세계문화유산으로 등재된 이곳은 한국 전통 건축의 정수를 느낄 수 있는 특별한 장소입니다.</p>
				</div>
				<div class="col-md-5">
					<img
						src="https://cdn.pixabay.com/photo/2022/11/13/08/58/palace-7588619_1280.jpg"
						style="width: 500px">
				</div>
			</div>
			...
			<div class="row featurette">
				<div class="col-md-7 order-md-2">
					<h2 class="featurette-heading fw-normal lh-1">
						화성 <span class="text-body-secondary">조선의 위엄을 담은 역사적 성곽</span>
					</h2>
					<p class="lead">수원화성은 조선 정조가 건립한 군사 요새로, 정밀한 성곽 구조와 아름다운 조경이
						특징입니다. 세계문화유산으로 등재된 이곳은 성곽을 따라 걸으며 역사와 전통의 향기를 느낄 수 있는 명소입니다.
						방문객들은 성곽의 성문, 방어시설, 그리고 멋진 전망을 즐길 수 있습니다.</p>
				</div>
				<div class="col-md-5 order-md-1">
					<img alt=""
						src="https://cdn.pixabay.com/photo/2018/11/09/11/04/mars-3804300_1280.jpg"
			...
			<div class="row featurette">
				<div class="col-md-7">
					<h2 class="featurette-heading fw-normal lh-1">
						불국사<span class="text-body-secondary">신라의 유서 깊은 불교 사원</span>
					</h2>
					<p class="lead">불국사는 신라 시대에 건립된 세계문화유산으로, 정교한 석탑과 석굴 사원이 유명합니다.
						고대 불교 예술의 정수를 보여주는 아름다운 사찰로, 역사와 문화가 어우러진 명소입니다.</p>
				</div>
				<div class="col-md-5">
					<img alt=""
						src="https://cdn.pixabay.com/photo/2016/05/17/12/16/the-bulguksa-temple-1398010_1280.jpg"
						style="width: 500px">
				</div>
			</div>
